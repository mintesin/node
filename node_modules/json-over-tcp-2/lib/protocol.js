...
const ProtocolError = exports.ProtocolError = function () {
  Error.apply(this, arguments)
}
ProtocolError.prototype = Object.create(Error.prototype)

const Protocol = exports.Protocol = function (stream) {
  if (!isStream(stream)) {
...
Protocol.prototype.write = function (obj, callback) {
...
Protocol.prototype._read = function (packet) {
  ...
  let packetOffset = 0
  let bufferRemainderLength
  let packetRemainderLength

	if (!isBuffer(packet)) {
		throw new TypeError('Packet must be a Buffer instance')
	}
...
Protocol.prototype._parseBuffer = function () {
  const jsonString = this._buffer.toString('utf-8'),
